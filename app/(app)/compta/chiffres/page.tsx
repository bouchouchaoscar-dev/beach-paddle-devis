                ...
                <div className="space-y-1 max-h-72 overflow-y-auto pr-1">
                  {Object.entries(monthEntriesByDate).map(([date, dayEntries]) => {
                    ...
                    return (
                      ...
                      >
                        {/* Left: date + notes + acompte badges */}
                        <div className="flex items-center gap-1.5 min-w-0 flex-1 flex-wrap">
                          ...
                          {acompteEntries.map((a) => (
                            <span
                              key={a.id}
                              className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md text-[10px] font-semibold bg-blue-50 text-blue-600 border border-blue-100 flex-shrink-0"
                            >
                        ...
                        {/* Right: total + edit/delete on main entry */}
