            ...
            {filtered.map((record, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* ── Ligne 2 : chips — whiteSpace nowrap sur le container pour forcer 1 ligne ── */}
                  <div style={{ whiteSpace: "nowrap", overflowX: "hidden", marginBottom: "12px", lineHeight: 1 }}>
                    {activityLabel && (
                      <span style={{ display: "inline-flex", alignItems: "center", gap: "4px", padding: "2px 8px", borderRadius: "6px", fontSize: "11px", fontWeight: 600, whiteSpace: "nowrap", backgroundColor: "rgba(0,113,227,0.10)", color: "#0071E3", marginRight: "6px", verticalAlign: "middle" }}>
                        <ActivityIcon activity={fd?.activity} />
                        {activityLabel}
                      </span>
                    )}
                    {durationLabel && (
                      <span style={{ display: "inline-flex", alignItems: "center", gap: "4px", padding: "2px 8px", borderRadius: "6px", fontSize: "11px", fontWeight: 600, whiteSpace: "nowrap", backgroundColor: "rgba(232,130,12,0.12)", color: "#B45309", marginRight: "6px", verticalAlign: "middle" }}>
                    ...
                    {record.participantsCount > 0 && (
                      <span style={{ display: "inline-flex", alignItems: "center", gap: "4px", padding: "2px 8px", borderRadius: "6px", fontSize: "11px", fontWeight: 600, whiteSpace: "nowrap", backgroundColor: "rgba(22,163,74,0.10)", color: "#16A34A", marginRight: "6px", verticalAlign: "middle" }}>
                        <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    {prestationDate && (
                      <span style={{ display: "inline-flex", alignItems: "center", gap: "4px", padding: "2px 8px", borderRadius: "6px", fontSize: "11px", fontWeight: 600, whiteSpace: "nowrap", backgroundColor: "rgba(124,58,237,0.10)", color: "#7C3AED", verticalAlign: "middle" }}>
                        <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
