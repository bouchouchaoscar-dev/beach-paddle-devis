            ...
            {filtered.map((record, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* ── Ligne 2 : chips — grid-auto-flow:column = 1 seule ligne garantie ── */}
                  <div style={{ display: "grid", gridAutoFlow: "column", gridAutoColumns: "max-content", gap: "6px", overflow: "hidden", marginBottom: "10px" }}>
                    {activityLabel && (
                      <span style={{ display: "flex", alignItems: "center", gap: "4px", padding: "2px 8px", borderRadius: "6px", fontSize: "11px", fontWeight: 600, whiteSpace: "nowrap", backgroundColor: "rgba(0,113,227,0.10)", color: "#0071E3" }}>
                        <ActivityIcon activity={fd?.activity} />
                        {activityLabel}
                      </span>
                    )}
                    {durationLabel && (
                      <span style={{ display: "flex", alignItems: "center", gap: "4px", padding: "2px 8px", borderRadius: "6px", fontSize: "11px", fontWeight: 600, whiteSpace: "nowrap", backgroundColor: "rgba(232,130,12,0.12)", color: "#B45309" }}>
                    ...
                    {record.participantsCount > 0 && (
                      <span style={{ display: "flex", alignItems: "center", gap: "4px", padding: "2px 8px", borderRadius: "6px", fontSize: "11px", fontWeight: 600, whiteSpace: "nowrap", backgroundColor: "rgba(22,163,74,0.10)", color: "#16A34A" }}>
                        <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    {prestationDate && (
                      <span style={{ display: "flex", alignItems: "center", gap: "4px", padding: "2px 8px", borderRadius: "6px", fontSize: "11px", fontWeight: 600, whiteSpace: "nowrap", backgroundColor: "rgba(124,58,237,0.10)", color: "#7C3AED" }}>
                        <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
